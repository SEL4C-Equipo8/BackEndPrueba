# Generated by Django 4.1.7 on 2023-10-03 01:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_actividad', models.ForeignKey(db_column='id_actividad', on_delete=django.db.models.deletion.CASCADE, to='SEL4c_app.actividades')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_actividad', models.ForeignKey(db_column='id_actividad', on_delete=django.db.models.deletion.CASCADE, to='SEL4c_app.actividades')),
                ('id_modulo', models.ForeignKey(db_column='id_modulo', on_delete=django.db.models.deletion.CASCADE, to='SEL4c_app.modulos')),
                ('id_usuario', models.ForeignKey(db_column='id_usuario', on_delete=django.db.models.deletion.CASCADE, to='SEL4c_app.usuario')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_modulo', models.OneToOneField(db_column='id_modulo', on_delete=django.db.models.deletion.CASCADE, to='SEL4c_app.modulos')),
            ],
        ),
        migrations.CreateModel(
            name='Estadisticas',
